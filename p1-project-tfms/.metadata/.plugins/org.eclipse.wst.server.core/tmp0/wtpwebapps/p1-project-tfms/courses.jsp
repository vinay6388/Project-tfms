...
<head>
  ...
  <title>Courses - Coding Wallah</title>
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              India <br><br>
              <strong>Phone:</strong> 044 4201 6145<br>
              <strong>Email:</strong> senthil@revature.com<br>
            </p>
          </div>
          ...
          <div class="col-lg-3 col-md-6 footer-links">
            ...
            <ul>
              ...
              <li><i class="bx bx-chevron-right"></i> <a href="#">Framework</a></li>
              <li><i class="bx bx-chevron-right"></i> <a href="#">Build Tool</a></li>
            </ul>
          </div>
